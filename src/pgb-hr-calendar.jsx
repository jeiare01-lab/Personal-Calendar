...
Return JSON exactly:
{
  ...
  "slots": [
    { "date": "${slots[0]}", "label": "This week",       "conflict": <true if date in existing dates, else false> },
    { "date": "${slots[1]}", "label": "Next week",       "conflict": <true if date in existing dates, else false> },
    { "date": "${slots[2]}", "label": "Week after next", "conflict": <true if date in existing dates, else false> }
  ]
}`;
    ...
    try {
      const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
        ...
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer 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",
          "HTTP-Referer": "https://personal-calendar-black.vercel.app",
          "X-Title": "PGB HR Calendar",
        },
        body: JSON.stringify({
      ...
      setAiError(err.message || "Couldn't parse that. Try rephrasing.");
